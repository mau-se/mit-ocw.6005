...
public class WordFinder {
    ...
    public static Map<String, Integer> getSubstrings(String haystack,
    	...
    	Map<String, Integer> listOfNeedles = new HashMap<String, Integer>();
    	//Pretty straight-forward, find lowest needle index in haystack
    	for(String s:needles){
    		if(haystack.contains(s)) {
    			listOfNeedles.putIfAbsent(s, haystack.indexOf(s));
    		}
    	}
    	
        return listOfNeedles;
    }
}
